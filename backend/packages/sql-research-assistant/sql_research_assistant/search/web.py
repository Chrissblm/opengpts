...
scrape_and_summarize: Runnable[Any, Any] = (
    ...
    | RunnableParallel(
        {
            "summary": SUMMARY_PROMPT | AzureChatOpenAI(temperature=0) | StrOutputParser(),
            "url": lambda x: x["url"],
        }
    )
...
search_query = SEARCH_PROMPT | AzureChatOpenAI(temperature=0) | StrOutputParser() | load_json
choose_agent = (
    CHOOSE_AGENT_PROMPT | AzureChatOpenAI(temperature=0) | StrOutputParser() | load_json
)
