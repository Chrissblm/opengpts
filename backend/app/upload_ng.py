...
# # Initialize an instance of AzureSearch
# azure_search_endpoint = envhelper.AZURE_SEARCH_SERVICE
# azure_search_key = envhelper.AZURE_SEARCH_KEY
# index_name = envhelper.AZURE_SEARCH_INDEX
# embedding_function = llms.get_openai_embedding()
...
# # Use azure_vector_store as the vector store for ingesting files
# ingest_runnable = IngestRunnable(
#     text_splitter=RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200),
#     vectorstore=azure_vector_store,
# ).configurable_fields(
